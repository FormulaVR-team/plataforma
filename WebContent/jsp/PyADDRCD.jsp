...
<body style="opacity:0.2;" onload="$('body').fadeTo('slow',1);">
    ...
    <html:form action="/PyADDRCD_A.do" styleClass="form-horizontal">
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="20" styleClass="form-control" property="py_sincro"  style="width: 140px;"/>
			</div>
		</div>
		<div class='form-group'>
			<label class="col-sm-3 control-label" for="textinput">mark&nbsp;</label>
			<div class="col-sm-9">
				<html:text maxlength="1" styleClass="form-control" property="py_mark"  style="width: 7px;"/>
			</div>
		</div>
		<div class='form-group'>
			<label class="col-sm-3 control-label" for="textinput">is_deleted&nbsp;</label>
			<div class="col-sm-9">
				<html:text maxlength="1" styleClass="form-control" property="py_is_deleted"  style="width: 7px;"/>
			</div>
		</div>
		<div class='form-group'>
			<label class="col-sm-3 control-label" for="textinput">author&nbsp;</label>
			<div class="col-sm-9">
				<html:text maxlength="50" styleClass="form-control" property="py_author"  style="width: 350px;"/>
			</div>
		</div>
		<div class='form-group'>
			<label class="col-sm-3 control-label" for="textinput"><span style='color:darkblue'>user_id&nbsp;</span></label>
			<div class="col-sm-9">
				<html:text maxlength="50" styleClass="form-control" property="py_user_id"  style="width: 350px;"/>
			</div>
		</div>
<!-- CAMPO VIRTUAL
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="100" styleClass="form-control" property="py_US_first_name"  disabled="true" style="width: 700px;"/>
			</div>
		</div>
-->
<!-- CAMPO VIRTUAL
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="100" styleClass="form-control" property="py_US_last_name"  disabled="true" style="width: 700px;"/>
			</div>
		</div>
-->
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="50" styleClass="form-control" property="py_reservation_id"  style="width: 350px;"/>
			</div>
		</div>
		<div class='form-group'>
			<label class="col-sm-3 control-label" for="textinput"><span style='color:darkblue'>paypal_token_id&nbsp;</span></label>
			<div class="col-sm-9">
				<html:text maxlength="100" styleClass="form-control" property="py_paypal_token_id"  style="width: 700px;"/>
			</div>
		</div>
		<div class='form-group'>
			<label class="col-sm-3 control-label" for="textinput">paypal_usr&nbsp;</label>
			<div class="col-sm-9">
				<html:text maxlength="100" styleClass="form-control" property="py_paypal_usr"  style="width: 700px;"/>
			</div>
		</div>
		<div class='form-group'>
			<label class="col-sm-3 control-label" for="textinput">paypal_pwd&nbsp;</label>
			<div class="col-sm-9">
				<html:text maxlength="100" styleClass="form-control" property="py_paypal_pwd"  style="width: 700px;"/>
			</div>
		</div>
		<div class='form-group'>
			<label class="col-sm-3 control-label" for="textinput">paypal_signature&nbsp;</label>
			<div class="col-sm-9">
				<html:text maxlength="100" styleClass="form-control" property="py_paypal_signature"  style="width: 700px;"/>
			</div>
		</div>
		<div class='form-group'>
			<label class="col-sm-3 control-label" for="textinput">stsProceso&nbsp;</label>
			<div class="col-sm-9">
				<html:text maxlength="10" styleClass="form-control" property="py_stsProceso"  style="width: 70px;"/>
			</div>
		</div>
		<div class='form-group'>
			<label class="col-sm-3 control-label" for="textinput">json&nbsp;</label>
			<div class="col-sm-9">
				<html:text maxlength="100" styleClass="form-control" property="py_json"  style="width: 700px;"/>
			</div>
		</div>
					...
					<div class="form-group">
						<div class="col-sm-9 col-sm-offset-3">
							...
							<input class="btn btn-primary" type="button" value="<bean:message key="common.client.nuevo"/>" onclick="if ( confirmar('<bean:message key="common.client.pregunta_grabar"/>',this)==true ) setOpcion('PyRCD_AF','NuevoReg',null);">
						</div>
					</div>
