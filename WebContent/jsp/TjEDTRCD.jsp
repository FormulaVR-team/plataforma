...
<body style="opacity:0.2;" onload="$('body').fadeTo('slow',1);">
	...
	<html:form action="/TjEDTRCD_A.do" styleClass="form-horizontal">
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="20" styleId="textinput" styleClass="form-control" property="tj_sincro"  style="width: 140px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="1" styleId="textinput" styleClass="form-control" property="tj_mark"  style="width: 7px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="1" styleId="textinput" styleClass="form-control" property="tj_is_deleted"  style="width: 7px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="50" styleId="textinput" styleClass="form-control" property="tj_author"  style="width: 350px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="50" styleId="textinput" styleClass="form-control" property="tj_card_id"  disabled="true" style="width: 350px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="12" styleId="textinput" styleClass="form-control" property="tj_balance_current"  style="text-align: right; width: 84px;" onkeypress="return soloNumeros(event);"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="12" styleId="textinput" styleClass="form-control" property="tj_last_sale_amount"  style="text-align: right; width: 84px;" onkeypress="return soloNumeros(event);"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="20" styleId="textinput" styleClass="form-control" property="tj_last_sale_moment"  style="width: 140px;"/>
			</div>
		</div>
					...
					<div class="form-group">
						<div class="col-sm-9 col-sm-offset-3">
							...
							<input class="btn btn-info" type="button" value="<bean:message key="common.client.leer"/>" onclick="setOpcion('TjRCD_AF','LeerReg',null);"> 
							<input class="btn btn-info"  type="button" value="<bean:message key="common.client.suprimir"/>" onclick="if ( confirmar('<bean:message key="common.client.pregunta_suprimir"/>',this)==true ) setOpcion('TjRCD_AF','Suprimir',null);">
							<input class="btn btn-primary" type="button" value="<bean:message key="common.client.grabar"/>"   onclick="if ( confirmar('<bean:message key="common.client.pregunta_modificar"/>',this)==true ) setOpcion('TjRCD_AF','CambiarReg',null);">
						</div>
					</div>
