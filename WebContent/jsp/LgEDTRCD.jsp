...
<body style="opacity:0.2;" onload="$('body').fadeTo('slow',1);">
	...
	<html:form action="/LgEDTRCD_A.do" styleClass="form-horizontal">
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="20" styleId="textinput" styleClass="form-control" property="lg_sincro"  style="width: 140px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="1" styleId="textinput" styleClass="form-control" property="lg_mark"  style="width: 7px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="1" styleId="textinput" styleClass="form-control" property="lg_is_deleted"  style="width: 7px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="50" styleId="textinput" styleClass="form-control" property="lg_author"  style="width: 350px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="5" styleId="textinput" styleClass="form-control" property="lg_serial"  disabled="true" style="text-align: right; width: 35px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="100" styleId="textinput" styleClass="form-control" property="lg_text_1"  style="width: 700px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="100" styleId="textinput" styleClass="form-control" property="lg_text_2"  style="width: 700px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="100" styleId="textinput" styleClass="form-control" property="lg_text_3"  style="width: 700px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="100" styleId="textinput" styleClass="form-control" property="lg_json"  style="width: 700px;"/>
			</div>
		</div>
					...
					<div class="form-group">
						<div class="col-sm-9 col-sm-offset-3">
							...
							<input class="btn btn-info" type="button" value="<bean:message key="common.client.leer"/>" onclick="setOpcion('LgRCD_AF','LeerReg',null);"> 
							<input class="btn btn-info"  type="button" value="<bean:message key="common.client.suprimir"/>" onclick="if ( confirmar('<bean:message key="common.client.pregunta_suprimir"/>',this)==true ) setOpcion('LgRCD_AF','Suprimir',null);">
							<input class="btn btn-primary" type="button" value="<bean:message key="common.client.grabar"/>"   onclick="if ( confirmar('<bean:message key="common.client.pregunta_modificar"/>',this)==true ) setOpcion('LgRCD_AF','CambiarReg',null);">
						</div>
					</div>
