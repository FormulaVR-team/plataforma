...
<html:form action="/LgDSPFIL_A.do" style="margin: 10px 10px;">
	...
	<div class="panel panel-default">
		...
		<div class="panel-heading">
			...
			<div class="btn-group pull-left">
				...
				<!-- <a href="#" class="btn btn-default btn-round" title="<bean:message   key="common.client.grabar"/>" data-rel="tooltip" onclick="if ( confirmar('<bean:message key="common.client.pregunta_modificar"/>',this)==true ) setOpcion('LgRCD_AF','Grabar', null);"><span class="glyphicon glyphicon-ok" ></span></a> -->                
				<a href="#" class="btn btn-default btn-round" title="<bean:message   key="common.client.nuevo"/>" data-rel="tooltip" onclick="setOpcion('LgRCD_AF','Nuevo', null);"><span class="glyphicon glyphicon-file" ></i></a>
				<a href="#" class="btn btn-default btn-round" title="<bean:message   key="common.client.marcar_todos"/>" data-rel="tooltip" onclick="setOpcion('LgRCD_AF','MarcarTodo', null);"><span class="glyphicon glyphicon-check" ></span></a>
				<a href="#" class="btn btn-default btn-round" title="<bean:message   key="common.client.desmarcar_todos"/>" data-rel="tooltip" onclick="setOpcion('LgRCD_AF','DesMarcarTodo', null);"><span class="glyphicon glyphicon-unchecked" ></span></a>                                                           
...
<th style="text-align: left;">json</th>
			...
			<logic:iterate indexId="gridIdx" id="grid" name="LgRCD_AF" property="grid">
				<tr id="laFila${gridIdx}">
					<td>
						<div class="table-btn">
							<html:multibox property="clavesMarcadas"  value="${grid.lg_serial}" onclick="javascript:multiboxClick('${gridIdx}');"/>
							<script type="text/javascript">multiboxClick('${gridIdx}');</script>
							<html:hidden name="grid" property="chg" indexed="true" />
							&nbsp;&nbsp;
							<a href="#" title="<bean:message key="common.client.modificar"/>" data-rel="tooltip" class="icon" onclick="setOpcion('LgRCD_AF','Edit${grid.lg_serial}', null );">
							    <i class="glyphicon glyphicon-pencil"></i>
							</a>
						</div>
					</td>
<td>&nbsp;<bean:write name="grid" property="lg_sincro"/><html:hidden name="grid" property="lg_sincro" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.lg_serial}';" />&nbsp;</td>   <!-- sincro -->
<td>&nbsp;<bean:write name="grid" property="lg_mark"/><html:hidden name="grid" property="lg_mark" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.lg_serial}';" />&nbsp;</td>   <!-- mark -->
<td>&nbsp;<bean:write name="grid" property="lg_is_deleted"/><html:hidden name="grid" property="lg_is_deleted" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.lg_serial}';" />&nbsp;</td>   <!-- is_deleted -->
<td><script>document.write(recortarTexto('<bean:write name="grid" property="lg_author"/>',30));</script><html:hidden name="grid" property="lg_author" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.lg_serial}';" />&nbsp;</td>   <!-- author -->
<td style="text-align: right;">&nbsp;<bean:write name="grid" property="lg_serial"/><html:hidden name="grid" property="lg_serial" indexed="true" />&nbsp;</td>   <!-- serial -->
<td><script>document.write(recortarTexto('<bean:write name="grid" property="lg_text_1"/>',30));</script><html:hidden name="grid" property="lg_text_1" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.lg_serial}';" />&nbsp;</td>   <!-- text_1 -->
<td><script>document.write(recortarTexto('<bean:write name="grid" property="lg_text_2"/>',30));</script><html:hidden name="grid" property="lg_text_2" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.lg_serial}';" />&nbsp;</td>   <!-- text_2 -->
<td><script>document.write(recortarTexto('<bean:write name="grid" property="lg_text_3"/>',30));</script><html:hidden name="grid" property="lg_text_3" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.lg_serial}';" />&nbsp;</td>   <!-- text_3 -->
<td><script>document.write(recortarTexto('<bean:write name="grid" property="lg_json"/>',30));</script><html:hidden name="grid" property="lg_json" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.lg_serial}';" />&nbsp;</td>   <!-- json -->
				</tr>
			</logic:iterate>
		</table>
...
<!-- modal -->
<%@include file="../inc/inc_LgDSPFIL_Flotante.jsp"%>
