...
<html>
                ...
                for (i=0;i<parms.length;i++) {
                    ...
                    if ( parm.length == 2 ) {
                        ...
                        if ( parm[0].toLowerCase() == 'form' )    
                            window.document.forms['RsRCD_AF'].elements["retFormulario"].value = parm[1];
                        if ( parm[0].toLowerCase() == 'element' ) 
                            window.document.forms['RsRCD_AF'].elements["retElemento"].value   = parm[1];
                        if ( parm[0].toLowerCase() == 'value' ) 
                            window.document.forms['RsRCD_AF'].elements["valorInicial"].value   = parm[1];
                    }
                }
                // Si es primera ejecución...(Si se le llamó con parámetros...)
                if ( parms.length > 1 ) {
                    // Inicializo primer restrictor con 'valor inicial' recibido:
                    window.document.forms['RsRCD_AF'].elements["rs_filtro.rs_sincro"].value   =                
                    window.document.forms['RsRCD_AF'].elements["valorInicial"].value;
                }
            }
            function setRetorno( retValor ) {
                var retFormulario = window.document.forms['RsRCD_AF'].elements["retFormulario"].value;
                var retElemento   = window.document.forms['RsRCD_AF'].elements["retElemento"].value;
    ...
    <body onload="javascript:persistePeticionario();" style="background-color: lightyellow; opacity:0.2;" onload="$('body').fadeTo('slow',1);">
        <html:form action="/RsSELRCD_A.do" style="margin: 10px 10px;">
            <table>
                <thead>
                    <tr>
                        <td colspan="100">
...
<td class="tbceldadetalle"><bean:write name="grid" property="rs_sincro"/><br/></td>   <!-- sincro -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_mark"/><br/></td>   <!-- mark -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_is_deleted"/><br/></td>   <!-- is_deleted -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_author"/><br/></td>   <!-- author -->
<td class="tbceldadetalle" onmouseover="onTdOver(this);" onmouseout="onTdOut(this);" onclick="javascript:setRetorno( '<bean:write name="grid" property="rs_reservation_id"/>' );"><bean:write name="grid" property="rs_reservation_id"/><br/></td>   <!-- reservation_id -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_location_id"/><br/></td>   <!-- location_id -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_LO_name"/><br/></td>   <!-- LO_name -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_user_id"/><br/></td>   <!-- user_id -->
<td class="tbceldadetalle" style="text-align: right;"><bean:write name="grid" property="rs_US_country_id"/><br/></td>   <!-- US_country_id -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_US_nick"/><br/></td>   <!-- US_nick -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_US_avatar"/><br/></td>   <!-- US_avatar -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_US_is_admin"/><br/></td>   <!-- US_is_admin -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_US_first_name"/><br/></td>   <!-- US_first_name -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_US_last_name"/><br/></td>   <!-- US_last_name -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_product_id"/><br/></td>   <!-- product_id -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_PT_name"/><br/></td>   <!-- PT_name -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_PT_deadline"/><br/></td>   <!-- PT_deadline -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_PT_isPercent"/><br/></td>   <!-- PT_isPercent -->
<td class="tbceldadetalle" style="text-align: right;"><bean:write name="grid" property="rs_PT_amount"/><br/></td>   <!-- PT_amount -->
<td class="tbceldadetalle" style="text-align: right;"><bean:write name="grid" property="rs_PT_duration_minutes"/><br/></td>   <!-- PT_duration_minutes -->
<td class="tbceldadetalle" style="text-align: right;"><bean:write name="grid" property="rs_quantity"/><br/></td>   <!-- quantity -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_product_id2"/><br/></td>   <!-- product_id2 -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_PT_name2"/><br/></td>   <!-- PT_name2 -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_PT_deadline2"/><br/></td>   <!-- PT_deadline2 -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_PT_isPercent2"/><br/></td>   <!-- PT_isPercent2 -->
<td class="tbceldadetalle" style="text-align: right;"><bean:write name="grid" property="rs_PT_amount2"/><br/></td>   <!-- PT_amount2 -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_product_id3"/><br/></td>   <!-- product_id3 -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_PT_name3"/><br/></td>   <!-- PT_name3 -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_PT_deadline3"/><br/></td>   <!-- PT_deadline3 -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_PT_isPercent3"/><br/></td>   <!-- PT_isPercent3 -->
<td class="tbceldadetalle" style="text-align: right;"><bean:write name="grid" property="rs_PT_amount3"/><br/></td>   <!-- PT_amount3 -->
<td class="tbceldadetalle" style="text-align: right;"><bean:write name="grid" property="rs_amount"/><br/></td>   <!-- amount -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_currency"/><br/></td>   <!-- currency -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_phone"/><br/></td>   <!-- phone -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_pay_status"/><br/></td>   <!-- pay_status -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_start_date"/><br/></td>   <!-- start_date -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_start_time"/><br/></td>   <!-- start_time -->
<td class="tbceldadetalle" style="text-align: right;"><bean:write name="grid" property="rs_duration_minutes"/><br/></td>   <!-- duration_minutes -->
<td class="tbceldadetalle" style="text-align: right;"><bean:write name="grid" property="rs_places"/><br/></td>   <!-- places -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_coupon_id"/><br/></td>   <!-- coupon_id -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_executed_at"/><br/></td>   <!-- executed_at -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_note"/><br/></td>   <!-- note -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_comment"/><br/></td>   <!-- comment -->
<td class="tbceldadetalle"><bean:write name="grid" property="rs_json"/><br/></td>   <!-- json -->
                    </tr>
                </logic:iterate>
            </table>
