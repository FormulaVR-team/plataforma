...
<body style="opacity:0.2;" onload="$('body').fadeTo('slow',1);">
	...
	<html:form action="/PmEDTRCD_A.do" styleClass="form-horizontal">
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="20" styleId="textinput" styleClass="form-control" property="pm_sincro"  style="width: 140px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="1" styleId="textinput" styleClass="form-control" property="pm_mark"  style="width: 7px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="1" styleId="textinput" styleClass="form-control" property="pm_is_deleted"  style="width: 7px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="50" styleId="textinput" styleClass="form-control" property="pm_author"  style="width: 350px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="50" styleId="textinput" styleClass="form-control" property="pm_coupon_id"  disabled="true" style="width: 350px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="100" styleId="textinput" styleClass="form-control" property="pm_name"  style="width: 700px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="5" styleId="textinput" styleClass="form-control" property="pm_uses_per_user"  style="text-align: right; width: 35px;" onkeypress="return soloNumeros(event);"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="100" styleId="textinput" styleClass="form-control" property="pm_PT_name"  disabled="true" style="width: 700px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="10" styleId="textinput" styleClass="form-control" property="pm_PT_whoCanSelect_AFU"  disabled="true" style="width: 70px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="10" styleId="textinput" styleClass="form-control" property="pm_PT_deadline"  disabled="true" style="width: 70px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="10" styleId="textinput" styleClass="form-control" property="pm_deadline"  style="width: 70px;"/>
			</div>
		</div>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="100" styleId="textinput" styleClass="form-control" property="pm_json"  style="width: 700px;"/>
			</div>
		</div>
					...
					<div class="form-group">
						<div class="col-sm-9 col-sm-offset-3">
							...
							<input class="btn btn-info" type="button" value="<bean:message key="common.client.leer"/>" onclick="setOpcion('PmRCD_AF','LeerReg',null);"> 
							<input class="btn btn-info"  type="button" value="<bean:message key="common.client.suprimir"/>" onclick="if ( confirmar('<bean:message key="common.client.pregunta_suprimir"/>',this)==true ) setOpcion('PmRCD_AF','Suprimir',null);">
							<input class="btn btn-primary" type="button" value="<bean:message key="common.client.grabar"/>"   onclick="if ( confirmar('<bean:message key="common.client.pregunta_modificar"/>',this)==true ) setOpcion('PmRCD_AF','CambiarReg',null);">
						</div>
					</div>
