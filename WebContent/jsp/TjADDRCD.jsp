...
<body style="opacity:0.2;" onload="$('body').fadeTo('slow',1);">
    ...
    <html:form action="/TjADDRCD_A.do" styleClass="form-horizontal">
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="50" styleClass="form-control" property="tj_user_id"  style="width: 350px;"/>
			</div>
		</div>
		<div class='form-group'>
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="100" styleClass="form-control" property="tj_qr_image_base64"  style="width: 700px;"/>
			</div>
		</div>
		<div class='form-group'>
			<label class="col-sm-3 control-label" for="textinput">json&nbsp;</label>
			<div class="col-sm-9">
				<html:text maxlength="100" styleClass="form-control" property="tj_json"  style="width: 700px;"/>
			</div>
		</div>
