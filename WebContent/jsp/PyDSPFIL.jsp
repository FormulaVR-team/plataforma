...
<html:form action="/PyDSPFIL_A.do" style="margin: 10px 10px;">
	...
	<div class="panel panel-default">
		...
		<div class="panel-heading">
			...
			<div class="btn-group pull-left">
				...
				<!-- <a href="#" class="btn btn-default btn-round" title="<bean:message   key="common.client.grabar"/>" data-rel="tooltip" onclick="if ( confirmar('<bean:message key="common.client.pregunta_modificar"/>',this)==true ) setOpcion('PyRCD_AF','Grabar', null);"><span class="glyphicon glyphicon-ok" ></span></a> -->                
				<a href="#" class="btn btn-default btn-round" title="<bean:message   key="common.client.nuevo"/>" data-rel="tooltip" onclick="setOpcion('PyRCD_AF','Nuevo', null);"><span class="glyphicon glyphicon-file" ></i></a>
				<a href="#" class="btn btn-default btn-round" title="<bean:message   key="common.client.marcar_todos"/>" data-rel="tooltip" onclick="setOpcion('PyRCD_AF','MarcarTodo', null);"><span class="glyphicon glyphicon-check" ></span></a>
				<a href="#" class="btn btn-default btn-round" title="<bean:message   key="common.client.desmarcar_todos"/>" data-rel="tooltip" onclick="setOpcion('PyRCD_AF','DesMarcarTodo', null);"><span class="glyphicon glyphicon-unchecked" ></span></a>                                                           
...
<th style="text-align: left;">json</th>
			...
			<logic:iterate indexId="gridIdx" id="grid" name="PyRCD_AF" property="grid">
				<tr id="laFila${gridIdx}">
					<td>
						<div class="table-btn">
							<html:multibox property="clavesMarcadas"  value="${grid.py_user_id}^${grid.py_reservation_id}^${grid.py_paypal_token_id}" onclick="javascript:multiboxClick('${gridIdx}');"/>
							<script type="text/javascript">multiboxClick('${gridIdx}');</script>
							<html:hidden name="grid" property="chg" indexed="true" />
							&nbsp;&nbsp;
							<a href="#" title="<bean:message key="common.client.modificar"/>" data-rel="tooltip" class="icon" onclick="setOpcion('PyRCD_AF','Edit${grid.py_user_id}^${grid.py_reservation_id}^${grid.py_paypal_token_id}', null );">
							    <i class="glyphicon glyphicon-pencil"></i>
							</a>
						</div>
					</td>
<td>&nbsp;<bean:write name="grid" property="py_sincro"/><html:hidden name="grid" property="py_sincro" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.py_user_id}^${grid.py_reservation_id}^${grid.py_paypal_token_id}';" />&nbsp;</td>   <!-- sincro -->
<td>&nbsp;<bean:write name="grid" property="py_mark"/><html:hidden name="grid" property="py_mark" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.py_user_id}^${grid.py_reservation_id}^${grid.py_paypal_token_id}';" />&nbsp;</td>   <!-- mark -->
<td>&nbsp;<bean:write name="grid" property="py_is_deleted"/><html:hidden name="grid" property="py_is_deleted" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.py_user_id}^${grid.py_reservation_id}^${grid.py_paypal_token_id}';" />&nbsp;</td>   <!-- is_deleted -->
<td><script>document.write(recortarTexto('<bean:write name="grid" property="py_author"/>',30));</script><html:hidden name="grid" property="py_author" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.py_user_id}^${grid.py_reservation_id}^${grid.py_paypal_token_id}';" />&nbsp;</td>   <!-- author -->
<td><script>document.write(recortarTexto('<bean:write name="grid" property="py_user_id"/>',30));</script><html:hidden name="grid" property="py_user_id" indexed="true" />&nbsp;</td>   <!-- user_id -->
<td><script>document.write(recortarTexto('<bean:write name="grid" property="py_US_first_name"/>',30));</script><html:hidden name="grid" property="py_US_first_name" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.py_user_id}^${grid.py_reservation_id}^${grid.py_paypal_token_id}';" />&nbsp;</td>   <!-- US_first_name -->
<td><script>document.write(recortarTexto('<bean:write name="grid" property="py_US_last_name"/>',30));</script><html:hidden name="grid" property="py_US_last_name" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.py_user_id}^${grid.py_reservation_id}^${grid.py_paypal_token_id}';" />&nbsp;</td>   <!-- US_last_name -->
<td><script>document.write(recortarTexto('<bean:write name="grid" property="py_reservation_id"/>',30));</script><html:hidden name="grid" property="py_reservation_id" indexed="true" />&nbsp;</td>   <!-- reservation_id -->
<td><script>document.write(recortarTexto('<bean:write name="grid" property="py_paypal_token_id"/>',30));</script><html:hidden name="grid" property="py_paypal_token_id" indexed="true" />&nbsp;</td>   <!-- paypal_token_id -->
<td><script>document.write(recortarTexto('<bean:write name="grid" property="py_paypal_usr"/>',30));</script><html:hidden name="grid" property="py_paypal_usr" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.py_user_id}^${grid.py_reservation_id}^${grid.py_paypal_token_id}';" />&nbsp;</td>   <!-- paypal_usr -->
<td><script>document.write(recortarTexto('<bean:write name="grid" property="py_paypal_pwd"/>',30));</script><html:hidden name="grid" property="py_paypal_pwd" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.py_user_id}^${grid.py_reservation_id}^${grid.py_paypal_token_id}';" />&nbsp;</td>   <!-- paypal_pwd -->
<td><script>document.write(recortarTexto('<bean:write name="grid" property="py_paypal_signature"/>',30));</script><html:hidden name="grid" property="py_paypal_signature" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.py_user_id}^${grid.py_reservation_id}^${grid.py_paypal_token_id}';" />&nbsp;</td>   <!-- paypal_signature -->
<td>&nbsp;<bean:write name="grid" property="py_stsProceso"/><html:hidden name="grid" property="py_stsProceso" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.py_user_id}^${grid.py_reservation_id}^${grid.py_paypal_token_id}';" />&nbsp;</td>   <!-- stsProceso -->
<td><script>document.write(recortarTexto('<bean:write name="grid" property="py_json"/>',30));</script><html:hidden name="grid" property="py_json" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.py_user_id}^${grid.py_reservation_id}^${grid.py_paypal_token_id}';" />&nbsp;</td>   <!-- json -->
				</tr>
			</logic:iterate>
		</table>
...
<!-- modal -->
<%@include file="../inc/inc_PyDSPFIL_Flotante.jsp"%>
