...
<td><script>document.write(recortarTexto('<bean:write name="grid" property="es_EV_locaition_id"/>',30));</script><html:hidden name="grid" property="es_EV_locaition_id" indexed="true" onchange="this.style.color='red';(document.getElementsByName('grid[${gridIdx}].chg'))[0].value='${grid.es_event_id}^${grid.es_inscription_user_id}';" />&nbsp;</td>   <!-- EV_locaition_id -->
