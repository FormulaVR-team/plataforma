...
<body style="opacity:0.2;" onload="$('body').fadeTo('slow',1);">
    ...
    <html:form action="/LpADDRCD_A.do" styleClass="form-horizontal">
		...
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="50" styleClass="form-control" property="lp_card_id"  style="width: 350px;"/>
			</div>
		</div>
<!-- CAMPO VIRTUAL
		<div class='form-group'>
...
-->
		<div class='form-group'>
			...
			<div class="col-sm-9">
				<html:text maxlength="100" styleClass="form-control" property="lp_json"  style="width: 700px;"/>
			</div>
		</div>
					...
					<div class="form-group">
						<div class="col-sm-9 col-sm-offset-3">
							...
							<input class="btn btn-primary" type="button" value="<bean:message key="common.client.nuevo"/>" onclick="if ( confirmar('<bean:message key="common.client.pregunta_grabar"/>',this)==true ) setOpcion('LpRCD_AF','NuevoReg',null);">
						</div>
					</div>
