...
<meta name="msapplication-TileImage" content="https://www.formulavr.net/wp-content/uploads/2017/06/cropped-formulvr-ico-270x270.png" />
	...
	<body layout="column" flex ng-controller="AppCtrl" ng-app="theNgApp" ng-cloak="" style="">
			...
			<md-content class="logon-content" style="">
			    ...
			    <section ng-show="showRegister">
			        ...
			        <md-card-actions layout="column">
								...
								<md-button onclick="forgotPass()" style="font-size: 12px;">Olvidé la contraseña</md-button>
								</div>
								...
								<logic:present name="noPwd-button-ON">
										<md-button class="md-raised md-warn" onclick="forgotPass()" style="font-size: 12px; text-transform: uppercase;">No tengo contraseña todavía</md-button>
							</logic:present>
				...
				<%--
				<div flow="column" style="width: 50%;">
	
					<section style="width: 50%;">

						<div md-colors="{color:'primary'}">Ya tengo usuario en FormulaVR</div>
						...
						<div layout="column" flex="auto">
							...
							<div>
								<md-input-container>
									<label>Correo electrónico</label>
									<input type="email" ng-model="logon_USR" required ng-pattern="/^.+@.+\..+$/" id="logon_USR" name="logon_USR" style="text-transform: lowercase;">
								</md-input-container>
							</div>
							<div>
								<md-input-container>
									<label>Contraseña</label>
									<input type="password" ng-model="logon_PWD" id="logon_PWD" name="logon_PWD">
								</md-input-container>
								<md-button class="md-raised" onclick="enter()">
							...
							<div layout="row" layout-align="start end">
								<md-button class="md-raised" onclick="newUser()">
									<md-icon>create</md-icon>
									<md-tooltip>Crear nuevo usuario</md-tooltip>
								</md-button>
								<md-label>Crear nuevo usuario<md-label>
							</div>
							<div layout="row" layout-align="start end">
								<md-button class="md-raised" onclick="forgotPass()">
									<md-icon> help_outline </md-icon>
									<md-tooltip>Olvidé la contraseña</md-tooltip>
								</md-button>
								<md-label>Solicitar o cambiar contraseña<md-label>
							</div>
	 ...
	 <%--
	 <footer>
			<div><html:errors property="error"/></div>
			<md-toolbar class="md-scroll-shrink" layout="row" layout-align="space-between center">
	...
	<script>
		...
		function forgotPass() { document.getElementsByName('opcionPantalla')[0].value='forgotPass'; document.forms[0].submit(); }
