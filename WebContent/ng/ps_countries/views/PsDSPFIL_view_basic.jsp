  ...
  <h1 class="page-title">PAÍSES</h1>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6">
			...
			<div class="btn-group" style="margin-top: 15px;margin-bottom: 10px;">
				...
				<md-button class="md-icon-button md-accent md-button md-ink-ripple margin-0" ng-click="initReg()" data-toggle="modal" data-target="#psDSPFIL_ADDRCD_modal">
					<md-tooltip><bean:message key="common.client.nuevo"/></md-tooltip>
					<md-icon> add </md-icon></md-button>
				<md-button class="md-icon-button md-accent md-button md-ink-ripple margin-0" onclick="$('#filterIcon').toggleClass('rotate');$('#psFilterBox').slideToggle();">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div id="psFilterBox" class="box" style="display:none;">
				<div class="row row-filter">
					...
					<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 pull-right">
						<md-button class=" md-raised md-primary md-button md-ink-ripple width-100" ng-click="filtrar()" onclick="$('#filterIcon').toggleClass('rotate');$('#psFilterBox').slideToggle();">Aplicar</md-button>
					</div>
