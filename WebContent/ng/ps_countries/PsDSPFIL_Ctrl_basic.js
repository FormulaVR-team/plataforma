...
//			scope: { dynamic: '=dynamic'},
	...
	.controller(
		...
		[
				...
				function($scope, $state, $stateParams, $window, $timeout, $mdToast, validationService, app_services, PsDSPFIL_service) {
					///////////////////////////////////////////////////////////////////////
					///////////////////////////////////////////////////////////////////////
					$scope.actionForm = {
							/////////////////////////////////////////////////
...
//						    , valorInicial					: ""
						    ...
						    , ps_filtro : {
								  ps_sincro: "" // sincro
								, ps_mark: "" // mark
								, ps_is_deleted: "" // is_deleted
								, ps_author: "" // author
								, ps_country_id: "" // country_id
								, ps_name: "" // name
								, ps_alpha_2: "" // alpha_2
								, ps_alpha_3: "" // alpha_3
								, ps_flag_base64: "" // flag_base64
								, ps_json: "" // json						
							}
					...
					$scope.actionForm.ps_filtro = angular.fromJson( $window.sessionStorage.getItem("PsDSPFIL.ps_filtro") );
					///////////////////////////////////////////////////////////////////////
					// Funciones internas:
					...
					$scope.putRecordAsTheCurrent = function( reg ) {
						// Formato de registro:
						$scope.actionForm.ps_sincro = reg.ps_sincro; // sincro
						$scope.actionForm.ps_mark = reg.ps_mark; // mark
						$scope.actionForm.ps_is_deleted = reg.ps_is_deleted; // is_deleted
						$scope.actionForm.ps_author = reg.ps_author; // author
						$scope.actionForm.ps_country_id = reg.ps_country_id; // country_id
						$scope.actionForm.ps_name = reg.ps_name; // name
						$scope.actionForm.ps_alpha_2 = reg.ps_alpha_2; // alpha_2
						$scope.actionForm.ps_alpha_3 = reg.ps_alpha_3; // alpha_3
						$scope.actionForm.ps_flag_base64 = reg.ps_flag_base64; // flag_base64
						$scope.actionForm.ps_json = reg.ps_json; // json						
					};

					$scope.initKey = function() {
						// Formato de registro:
						$scope.actionForm.ps_country_id = ""; // country_id						
					};

					$scope.initReg = function() {
						// Formato de registro:
						$scope.actionForm.ps_sincro = ""; // sincro
						$scope.actionForm.ps_mark = ""; // mark
						$scope.actionForm.ps_is_deleted = ""; // is_deleted
						$scope.actionForm.ps_author = ""; // author
						$scope.actionForm.ps_country_id = ""; // country_id
						$scope.actionForm.ps_name = ""; // name
						$scope.actionForm.ps_alpha_2 = ""; // alpha_2
						$scope.actionForm.ps_alpha_3 = ""; // alpha_3
						$scope.actionForm.ps_flag_base64 = ""; // flag_base64
						$scope.actionForm.ps_json = ""; // json						
					};
