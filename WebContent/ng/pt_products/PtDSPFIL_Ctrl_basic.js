...
//			scope: { dynamic: '=dynamic'},
	...
	.controller(
		...
		[
				...
				function($scope, $state, $stateParams, $window, $timeout, $mdToast, validationService, app_services, PtDSPFIL_service) {
					///////////////////////////////////////////////////////////////////////
					///////////////////////////////////////////////////////////////////////
					$scope.actionForm = {
							/////////////////////////////////////////////////
...
//						    , valorInicial					: ""
						    ...
						    , pt_filtro : {
								  pt_sincro: "" // sincro
								, pt_mark: "" // mark
								, pt_is_deleted: "" // is_deleted
								, pt_author: "" // author
								, pt_product_id: "" // product_id
								, pt_name: "" // name
								, pt_whoCanSelect_AFU: "" // whoCanSelect_AFU
								, pt_deadline: "" // deadline
								, pt_isPercent: "" // isPercent
								, pt_amount: "" // amount
								, pt_currency: "" // currency
								, pt_duration_minutes: "" // duration_minutes
								, pt_json: "" // json						
							}
					...
					$scope.actionForm.pt_filtro = angular.fromJson( $window.sessionStorage.getItem("PtDSPFIL.pt_filtro") );
					///////////////////////////////////////////////////////////////////////
					// Funciones internas:
					...
					$scope.putRecordAsTheCurrent = function( reg ) {
						// Formato de registro:
						$scope.actionForm.pt_sincro = reg.pt_sincro; // sincro
						$scope.actionForm.pt_mark = reg.pt_mark; // mark
						$scope.actionForm.pt_is_deleted = reg.pt_is_deleted; // is_deleted
						$scope.actionForm.pt_author = reg.pt_author; // author
						$scope.actionForm.pt_product_id = reg.pt_product_id; // product_id
						$scope.actionForm.pt_name = reg.pt_name; // name
						$scope.actionForm.pt_whoCanSelect_AFU = reg.pt_whoCanSelect_AFU; // whoCanSelect_AFU
						$scope.actionForm.pt_deadline = reg.pt_deadline; // deadline
						$scope.actionForm.pt_isPercent = reg.pt_isPercent; // isPercent
						$scope.actionForm.pt_amount = reg.pt_amount; // amount
						$scope.actionForm.pt_currency = reg.pt_currency; // currency
						$scope.actionForm.pt_duration_minutes = reg.pt_duration_minutes; // duration_minutes
						$scope.actionForm.pt_json = reg.pt_json; // json						
					};

					$scope.initKey = function() {
						// Formato de registro:
						$scope.actionForm.pt_product_id = ""; // product_id						
					};

					$scope.initReg = function() {
						// Formato de registro:
						$scope.actionForm.pt_sincro = ""; // sincro
						$scope.actionForm.pt_mark = ""; // mark
						$scope.actionForm.pt_is_deleted = ""; // is_deleted
						$scope.actionForm.pt_author = ""; // author
						$scope.actionForm.pt_product_id = ""; // product_id
						$scope.actionForm.pt_name = ""; // name
						$scope.actionForm.pt_whoCanSelect_AFU = ""; // whoCanSelect_AFU
						$scope.actionForm.pt_deadline = ""; // deadline
						$scope.actionForm.pt_isPercent = ""; // isPercent
						$scope.actionForm.pt_amount = ""; // amount
						$scope.actionForm.pt_currency = ""; // currency
						$scope.actionForm.pt_duration_minutes = ""; // duration_minutes
						$scope.actionForm.pt_json = ""; // json						
					};
...
//						}
	...
	// Panel empotrado de "EDTRCD" (por si no se quiere tener esta función en una vista independiente)
					$scope.copiar = function() {
						$scope.initKey();
						$('#ptDSPFIL_EDTRCD_modal').modal('hide');
						$('#ptDSPFIL_ADDRCD_modal').modal('show');
					};
