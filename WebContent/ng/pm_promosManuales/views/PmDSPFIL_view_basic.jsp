...
<div class="container">
  <!-- Modal -->
  <div class="modal fade modal-full-width" id="pmDSPFIL_ADDRCD_modal" role="dialog" data-backdrop="false">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title">Agregar: promosManuales</h2>
        </div>
...
<div class="container">
  <!-- Modal -->
  <div class="modal fade modal-full-width" id="pmDSPFIL_EDTRCD_modal" role="dialog" data-backdrop="false">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">
          ...
          <h2 class="modal-title">Modificar: promosManuales</h2>
        </div>
        <div class="modal-body">
