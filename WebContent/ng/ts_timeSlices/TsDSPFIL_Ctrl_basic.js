...
//			scope: { dynamic: '=dynamic'},
	...
	.controller(
		...
		[
				...
				function($scope, $state, $stateParams, $window, $timeout, $mdToast, validationService, app_services, TsDSPFIL_service) {
					///////////////////////////////////////////////////////////////////////
					///////////////////////////////////////////////////////////////////////
					$scope.actionForm = {
							/////////////////////////////////////////////////
...
//						    , valorInicial					: ""
						    ...
						    , ts_filtro : {
								  ts_sincro: "" // sincro
								, ts_mark: "" // mark
								, ts_is_deleted: "" // is_deleted
								, ts_author: "" // author
								, ts_reservation_id: "" // reservation_id
								, ts_RS_user_id: "" // RS_user_id
								, ts_RS_location_id: "" // RS_location_id
								, ts_RS_start_date: "" // RS_start_date
								, ts_RS_start_time: "" // RS_start_time
								, ts_RS_pay_status: "" // RS_pay_status
								, ts_RS_product_id: "" // RS_product_id
								, ts_RS_quantity: "" // RS_quantity
								, ts_RS_duration_minutes: "" // RS_duration_minutes
								, ts_RS_places: "" // RS_places
				    ...
				    $scope.aux_FLT_ts_RS_location_id = "";
				    /////
				    /////
					...
					$scope.actionForm.ts_filtro = angular.fromJson( $window.sessionStorage.getItem("TsDSPFIL.ts_filtro") );
					if ( null != $scope.actionForm.ts_filtro ) {
					    // Combos y auxiliares para componentes de presentación:
						$scope.aux_FLT_ts_RS_location_id = {value: $scope.actionForm.ts_filtro.ts_RS_location_id, displayName: ""};
					}
					///////////////////////////////////////////////////////////////////////
					// Funciones internas:
					...
					$scope.filtrar = function() {
					    ...
					    // Combos y auxiliares para componentes de presentación:
					    $scope.actionForm.ts_filtro.ts_RS_location_id = $scope.aux_FLT_ts_RS_location_id.value;
					...
					$scope.putRecordAsTheCurrent = function( reg ) {
						// Formato de registro:
						$scope.actionForm.ts_sincro = reg.ts_sincro; // sincro
						$scope.actionForm.ts_mark = reg.ts_mark; // mark
						$scope.actionForm.ts_is_deleted = reg.ts_is_deleted; // is_deleted
						$scope.actionForm.ts_author = reg.ts_author; // author
						$scope.actionForm.ts_reservation_id = reg.ts_reservation_id; // reservation_id
						$scope.actionForm.ts_RS_user_id = reg.ts_RS_user_id; // RS_user_id
						$scope.actionForm.ts_RS_location_id = reg.ts_RS_location_id; // RS_location_id
						$scope.actionForm.ts_RS_start_date = reg.ts_RS_start_date; // RS_start_date
						$scope.actionForm.ts_RS_start_time = reg.ts_RS_start_time; // RS_start_time
						$scope.actionForm.ts_RS_pay_status = reg.ts_RS_pay_status; // RS_pay_status
						$scope.actionForm.ts_RS_product_id = reg.ts_RS_product_id; // RS_product_id
						$scope.actionForm.ts_RS_quantity = reg.ts_RS_quantity; // RS_quantity
						$scope.actionForm.ts_RS_duration_minutes = reg.ts_RS_duration_minutes; // RS_duration_minutes
						$scope.actionForm.ts_RS_places = reg.ts_RS_places; // RS_places
						$scope.actionForm.ts_start_date = reg.ts_start_date; // start_date
						$scope.actionForm.ts_start_time = reg.ts_start_time; // start_time
						$scope.actionForm.ts_json = reg.ts_json; // json						
					};

					$scope.initKey = function() {
						// Formato de registro:
						$scope.actionForm.ts_reservation_id = ""; // reservation_id
						$scope.actionForm.ts_start_date = ""; // start_date
						$scope.actionForm.ts_start_time = ""; // start_time						
					};

					$scope.initReg = function() {
						// Formato de registro:
						$scope.actionForm.ts_sincro = ""; // sincro
						$scope.actionForm.ts_mark = ""; // mark
						$scope.actionForm.ts_is_deleted = ""; // is_deleted
						$scope.actionForm.ts_author = ""; // author
						$scope.actionForm.ts_reservation_id = ""; // reservation_id
						$scope.actionForm.ts_RS_user_id = ""; // RS_user_id
						$scope.actionForm.ts_RS_location_id = ""; // RS_location_id
						$scope.actionForm.ts_RS_start_date = ""; // RS_start_date
						$scope.actionForm.ts_RS_start_time = ""; // RS_start_time
						$scope.actionForm.ts_RS_pay_status = ""; // RS_pay_status
						$scope.actionForm.ts_RS_product_id = ""; // RS_product_id
						$scope.actionForm.ts_RS_quantity = ""; // RS_quantity
						$scope.actionForm.ts_RS_duration_minutes = ""; // RS_duration_minutes
						$scope.actionForm.ts_RS_places = ""; // RS_places
						$scope.actionForm.ts_start_date = ""; // start_date
						$scope.actionForm.ts_start_time = ""; // start_time
						$scope.actionForm.ts_json = ""; // json						
					};
...
//						}
	...
	// Panel empotrado de "EDTRCD" (por si no se quiere tener esta función en una vista independiente)
					$scope.copiar = function() {
						$scope.initKey();
						$('#tsDSPFIL_ADDRCD_modal').modal('show');
					};
