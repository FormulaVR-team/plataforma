...
<%-- 
						<div  id="filaFiltros" class="col-xs-12" style="display: none;margin-bottom: 10px;">
							<!-- Caja de filtros inicio -->
							<div colspan="row" id="rsFilterBox">
								<div class="col-xs-12">
									...
									<div class="row" style="margin-left: 0px; margin-right: 0px;">
										...
										<md-input-container  class="col-xs-12 col-sm-6 col-md-3">
											...
											<input type="text" ng-model="actionForm.rs_filtro.rs_reservation_id" />
										</md-input-container>
										<md-input-container  class="col-xs-12 col-sm-6 col-md-3">
											<label>Concepto</label>
											<input type="text" ng-model="actionForm.rs_filtro.rs_PT_name" />
										</md-input-container>
			
										<!-- pay_status -->
										<md-input-container  class="col-xs-12 col-sm-6 col-md-3">
											<label>Pagos</label>
											<md-select placeholder="Pagos" ng-model="actionForm.rs_filtro.rs_pay_status">
												<md-optgroup label="Pagos">
													<md-option ng-repeat="item in lst_pay_status" value="{{item}}">{{item}}</md-option>
												</md-optgroup>			
											</md-select>
										</md-input-container>
										<!-- pay_status fin -->
					...
					<!-- 
										<md-input-container  class="col-xs-12 col-sm-6 col-md-3">
											<label>tfno.</label>
											<input type="text" ng-model="actionForm.rs_filtro.rs_phone" />
										</md-input-container>
										<md-input-container>
											<label>hora</label>
											<input type="text" ng-model="actionForm.rs_filtro.rs_start_time" />
										</md-input-container>
										<md-input-container>
											<label>minutos</label>
											<input type="text" ng-model="actionForm.rs_filtro.rs_duration_minutes" />
										</md-input-container>
										<md-input-container>
											<label>places</label>
											<input type="text" ng-model="actionForm.rs_filtro.rs_places" />
										</md-input-container>
										<md-input-container>
											<label>note</label>
											<input type="text" ng-model="actionForm.rs_filtro.rs_note" />
										</md-input-container>
					 -->
									</div>
			
									<div class="col-xs-12" style="text-align: right;">
										<md-button class=" md-raised md-primary md-button md-ink-ripple" ng-click="filtrar()" onclick="$('#filterIcon').toggleClass('rotate');$('#filaFiltros').slideToggle(400);">Filtrar</md-button>
									</div>
