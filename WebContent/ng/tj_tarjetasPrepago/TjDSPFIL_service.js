	        ...
	        ,  function($http,$window) {
		        	...
		        	return {
		        		filtrar: function(actionForm) {
		        			/////////////////////////
		        			// Persistir su filtro:
		        			$window.sessionStorage.setItem("TjDSPFIL.tj_filtro", angular.toJson( actionForm.tj_filtro ));
		        	  ...
		        	  , add: function(actionForm){
		        			...
		        			return $http({
		        				url: './TjADDRCD_A.do',		// No es DSPFIL, es ADDRCD. ATENCIÓN !!!
		        				method: 'POST',
		        				data: actionForm
				            }).then ( function( response) { return response; });
		        		}
		        	  , chg: function(actionForm){
		        			...
		        			return $http({
		 		                url: './TjEDTRCD_A.do',		// No es DSPFIL, es EDTRCD. ATENCIÓN !!!
		 		                method: 'POST',
		 		                data: actionForm
				            }).then ( function( response) { return response; });
		        		}
