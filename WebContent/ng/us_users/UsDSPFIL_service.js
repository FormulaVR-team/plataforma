	        ...
	        ,  function($http,$window) {
		        	...
		        	return {
		        		filtrar: function(actionForm) {
		        			/////////////////////////
		        			// Persistir su filtro:
		        			$window.sessionStorage.setItem("UsDSPFIL.us_filtro", angular.toJson( actionForm.us_filtro ));
		        	  ...
		        	  , add: function(actionForm){
		        			...
		        			return $http({
		        				url: './UsADDRCD_A.do',		// No es DSPFIL, es ADDRCD. ATENCIÓN !!!
		        				method: 'POST',
		        				data: actionForm
				            }).then ( function( response) { return response; });
		        		}
		        	  , chg: function(actionForm){
		        			...
		        			return $http({
		 		                url: './UsEDTRCD_A.do',		// No es DSPFIL, es EDTRCD. ATENCIÓN !!!
		 		                method: 'POST',
		 		                data: actionForm
				            }).then ( function( response) { return response; });
		        		}
	        		  ...
	        		  , conectarComo: function(actionForm) {
			       			actionForm.opcionPantalla = "conectarComo";
			       			return $http({
					                url: './UsDSPFIL_A.do',
					                method: 'POST',
					                data: actionForm
