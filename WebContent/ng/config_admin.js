...
$mdThemingProvider
	...
	.state('AcDSPFIL', {
		...
		views: {
			...
			"rgnZoom": {
				templateUrl: "./ng/ac_activityCockpits/views/AcDSPFIL_view_zoom.jsp?version=fake4",
				controller: "AcDSPFIL_Ctrl_basic"
			},
			"rgnMain": {
				templateUrl: "./ng/ac_activityCockpits/views/AcDSPFIL_view_group10.jsp?version=fake4",
	...
	.state('CpDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/cp_cockpits/views/CpDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('EsDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/es_eventSusbscriptions/views/EsDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('EvDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/ev_events/views/EvDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('LgDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/lg_logs/views/LgDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('LoDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/lo_location/views/LoDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('CdDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/cd_LocationClosedDays/views/CdDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('PaDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/pa_systemParameters/views/PaDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('PmDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/pm_promosManuales/views/PmDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('PrDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/pr_promos/views/PrDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('PsDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/ps_countries/views/PsDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('PtDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/pt_products/views/PtDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('PyDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/py_PayPalTokens/views/PyDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('allRsDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/ad_rs_reservations/views/Ad_rsDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('SgDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/sg_publicProcesses/views/SgDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('TjDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/tj_tarjetasPrepago/views/TjDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('TkDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/tk_tokens/views/TkDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('TsDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/ts_timeSlices/views/TsDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('TtDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/tt_timeTableReference/views/TtDSPFIL_view_basic.jsp?version=fake4",
	...
	.state('UsDSPFIL', {
		...
		views: {
			...
			"rgnMain": {
				templateUrl: "./ng/us_users/views/UsDSPFIL_view_basic.jsp?version=fake4",
