...
//			scope: { dynamic: '=dynamic'},
	...
	.controller(
		...
		[
				...
				function($scope, $state, $stateParams, $window, $timeout, $mdToast, validationService, app_services, SgDSPFIL_service) {
					///////////////////////////////////////////////////////////////////////
					///////////////////////////////////////////////////////////////////////
					$scope.actionForm = {
							/////////////////////////////////////////////////
...
//						    , valorInicial					: ""
						    ...
						    , sg_filtro : {
								  sg_sincro: "" // sincro
								, sg_mark: "" // mark
								, sg_is_deleted: "" // is_deleted
								, sg_author: "" // author
								, sg_role_id: "" // role_id
								, sg_process_id: "" // process_id
								, sg_json: "" // json						
							}
					...
					$scope.actionForm.sg_filtro = angular.fromJson( $window.sessionStorage.getItem("SgDSPFIL.sg_filtro") );
					///////////////////////////////////////////////////////////////////////
					// Funciones internas:
					...
					$scope.putRecordAsTheCurrent = function( reg ) {
						// Formato de registro:
						$scope.actionForm.sg_sincro = reg.sg_sincro; // sincro
						$scope.actionForm.sg_mark = reg.sg_mark; // mark
						$scope.actionForm.sg_is_deleted = reg.sg_is_deleted; // is_deleted
						$scope.actionForm.sg_author = reg.sg_author; // author
						$scope.actionForm.sg_role_id = reg.sg_role_id; // role_id
						$scope.actionForm.sg_process_id = reg.sg_process_id; // process_id
						$scope.actionForm.sg_json = reg.sg_json; // json						
					};

					$scope.initKey = function() {
						// Formato de registro:
						$scope.actionForm.sg_role_id = ""; // role_id
						$scope.actionForm.sg_process_id = ""; // process_id						
					};

					$scope.initReg = function() {
						// Formato de registro:
						$scope.actionForm.sg_sincro = ""; // sincro
						$scope.actionForm.sg_mark = ""; // mark
						$scope.actionForm.sg_is_deleted = ""; // is_deleted
						$scope.actionForm.sg_author = ""; // author
						$scope.actionForm.sg_role_id = ""; // role_id
						$scope.actionForm.sg_process_id = ""; // process_id
						$scope.actionForm.sg_json = ""; // json						
					};
...
//						}
	...
	// Panel empotrado de "EDTRCD" (por si no se quiere tener esta función en una vista independiente)
					$scope.copiar = function() {
						$scope.initKey();
						$('#sgDSPFIL_EDTRCD_modal').modal('hide');
						$('#sgDSPFIL_ADDRCD_modal').modal('show');
					};
