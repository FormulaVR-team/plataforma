...
//			scope: { dynamic: '=dynamic'},
	...
	.controller(
		...
		[
				...
				function($scope, $state, $stateParams, $window, $timeout, $mdToast, validationService, app_services, LgDSPFIL_service) {
					///////////////////////////////////////////////////////////////////////
					///////////////////////////////////////////////////////////////////////
					$scope.actionForm = {
							/////////////////////////////////////////////////
...
//						    , valorInicial					: ""
					...
					$scope.actionForm.lg_filtro = angular.fromJson( $window.sessionStorage.getItem("LgDSPFIL.lg_filtro") );
					///////////////////////////////////////////////////////////////////////
					// Funciones internas:
					...
					$scope.putRecordAsTheCurrent = function( reg ) {
						// Formato de registro:
						$scope.actionForm.lg_sincro = reg.lg_sincro; // sincro
						$scope.actionForm.lg_mark = reg.lg_mark; // mark
						$scope.actionForm.lg_is_deleted = reg.lg_is_deleted; // is_deleted
						$scope.actionForm.lg_author = reg.lg_author; // author
						$scope.actionForm.lg_serial = reg.lg_serial; // serial
						$scope.actionForm.lg_text_1 = reg.lg_text_1; // text_1
						$scope.actionForm.lg_text_2 = reg.lg_text_2; // text_2
						$scope.actionForm.lg_text_3 = reg.lg_text_3; // text_3
						$scope.actionForm.lg_json = JSON.stringify(reg.lg_json); // json						
					};

					$scope.initKey = function() {
						// Formato de registro:
						$scope.actionForm.lg_serial = ""; // serial						
					};

					$scope.initReg = function() {
						// Formato de registro:
						$scope.actionForm.lg_sincro = ""; // sincro
						$scope.actionForm.lg_mark = ""; // mark
						$scope.actionForm.lg_is_deleted = ""; // is_deleted
						$scope.actionForm.lg_author = ""; // author
						$scope.actionForm.lg_serial = ""; // serial
						$scope.actionForm.lg_text_1 = ""; // text_1
						$scope.actionForm.lg_text_2 = ""; // text_2
						$scope.actionForm.lg_text_3 = ""; // text_3
						$scope.actionForm.lg_json = ""; // json						
					};
...
//						}
	...
	// Panel empotrado de "EDTRCD" (por si no se quiere tener esta función en una vista independiente)
					$scope.copiar = function() {
						$scope.initKey();
						$('#lgDSPFIL_EDTRCD_modal').modal('hide');
						$('#lgDSPFIL_ADDRCD_modal').modal('show');
					};
