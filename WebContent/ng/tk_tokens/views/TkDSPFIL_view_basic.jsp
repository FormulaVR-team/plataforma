...
<div name="TkDSPFIL_form">
	...
	<h1 class="page-title">TOKENS (CONTINUACIÓN DE FLUJOS REMOTOS: correos...)</h1>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6">
			...
			<div class="btn-group" style="margin-top: 15px;margin-bottom: 10px;">
				...
				<md-button class="md-icon-button md-accent md-button md-ink-ripple margin-0" ng-click="initReg()" data-toggle="modal" data-target="#tkDSPFIL_ADDRCD_modal">
					<md-tooltip><bean:message key="common.client.nuevo"/></md-tooltip>
					<md-icon> add </md-icon></md-button>
				<md-button class="md-icon-button md-accent md-button md-ink-ripple margin-0" onclick="$('#filterIcon').toggleClass('rotate');$('#tkFilterBox').slideToggle();">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div id="tkFilterBox" class="box" style="display:none;">
				<div class="row row-filter">
					...
					<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 pull-right">
						<md-button class=" md-raised md-primary md-button md-ink-ripple width-100" ng-click="filtrar()" onclick="$('#filterIcon').toggleClass('rotate');$('#tkFilterBox').slideToggle();">Aplicar</md-button>
					</div>
				</div>
			</div>
...
<div class="container">
  <!-- Modal -->
  <div class="modal fade modal-full-width" id="tkDSPFIL_ADDRCD_modal" role="dialog" data-backdrop="false">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title">Agregar: tokens</h2>
        </div>
...
<div class="container">
  <!-- Modal -->
  <div class="modal fade modal-full-width" id="tkDSPFIL_EDTRCD_modal" role="dialog" data-backdrop="false">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">
          ...
          <h2 class="modal-title">Modificar: tokens</h2>
        </div>
        <div class="modal-body">
