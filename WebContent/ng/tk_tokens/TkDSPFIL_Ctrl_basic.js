...
//			scope: { dynamic: '=dynamic'},
	...
	.controller(
		...
		[
				...
				function($scope, $state, $stateParams, $window, $timeout, $mdToast, validationService, app_services, TkDSPFIL_service) {
					///////////////////////////////////////////////////////////////////////
					///////////////////////////////////////////////////////////////////////
					$scope.actionForm = {
							/////////////////////////////////////////////////
...
//						    , valorInicial					: ""
						    ...
						    , tk_filtro : {
								  tk_sincro: "" // sincro
								, tk_mark: "" // mark
								, tk_is_deleted: "" // is_deleted
								, tk_author: "" // author
								, tk_token_id: "" // token_id
								, tk_json: "" // json						
							}
					...
					$scope.actionForm.tk_filtro = angular.fromJson( $window.sessionStorage.getItem("TkDSPFIL.tk_filtro") );
					///////////////////////////////////////////////////////////////////////
					// Funciones internas:
					...
					$scope.putRecordAsTheCurrent = function( reg ) {
						// Formato de registro:
						$scope.actionForm.tk_sincro = reg.tk_sincro; // sincro
						$scope.actionForm.tk_mark = reg.tk_mark; // mark
						$scope.actionForm.tk_is_deleted = reg.tk_is_deleted; // is_deleted
						$scope.actionForm.tk_author = reg.tk_author; // author
						$scope.actionForm.tk_token_id = reg.tk_token_id; // token_id
						$scope.actionForm.tk_json = JSON.stringify( reg.tk_json ); // json						
					};

					$scope.initKey = function() {
						// Formato de registro:
						$scope.actionForm.tk_token_id = ""; // token_id						
					};

					$scope.initReg = function() {
						// Formato de registro:
						$scope.actionForm.tk_sincro = ""; // sincro
						$scope.actionForm.tk_mark = ""; // mark
						$scope.actionForm.tk_is_deleted = ""; // is_deleted
						$scope.actionForm.tk_author = ""; // author
						$scope.actionForm.tk_token_id = ""; // token_id
						$scope.actionForm.tk_json = ""; // json						
					};
...
//						}
	...
	// Panel empotrado de "EDTRCD" (por si no se quiere tener esta función en una vista independiente)
					$scope.copiar = function() {
						$scope.initKey();
						$('#tkDSPFIL_EDTRCD_modal').modal('hide');
						$('#tkDSPFIL_ADDRCD_modal').modal('show');
					};
