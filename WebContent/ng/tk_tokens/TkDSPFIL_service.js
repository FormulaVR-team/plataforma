	        ...
	        ,  function($http,$window) {
		        	...
		        	return {
		        		filtrar: function(actionForm) {
		        			/////////////////////////
		        			// Persistir su filtro:
		        			$window.sessionStorage.setItem("TkDSPFIL.tk_filtro", angular.toJson( actionForm.tk_filtro ));
		        	  ...
		        	  , add: function(actionForm){
		        			...
		        			return $http({
		        				url: './TkADDRCD_A.do',		// No es DSPFIL, es ADDRCD. ATENCIÓN !!!
		        				method: 'POST',
		        				data: actionForm
				            }).then ( function( response) { return response; });
		        		}
		        	  , chg: function(actionForm){
		        			...
		        			return $http({
		 		                url: './TkEDTRCD_A.do',		// No es DSPFIL, es EDTRCD. ATENCIÓN !!!
		 		                method: 'POST',
		 		                data: actionForm
				            }).then ( function( response) { return response; });
		        		}
