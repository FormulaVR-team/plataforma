...
public class PrBean extends StBean {
    ...
    public PrBean(Object nulo) { super(); }
	...
	this.setPr_min_quantity( 0 ); // min_quantity
    } 
 /*
...
*/
    ...
    public String getKey(){
		 return pr_location_id + "^" + 
		pr_product_id;}

    public void setKey(String key){
            String k="";
	k = key.trim().substring( 0, key.indexOf("^") ); this.setPr_location_id( k ); key = key.trim().substring( key.indexOf("^")+1 );
	k = key; this.setPr_product_id( k );
    }
	////////////////////////////////////////////////////////////
	public String serializar() {
		...
		out.append( _K.sepFld ); out.append( this.getPr_min_quantity() ); // min_quantity
	...
	public void deserializar(String in) {
		...
		if ( in != null && in.length() > 0 ) {
			...
			try { this.setPr_min_quantity( Subrutinas.parse_long( trozos[11] )); } catch (Exception e) {;} // min_quantity
