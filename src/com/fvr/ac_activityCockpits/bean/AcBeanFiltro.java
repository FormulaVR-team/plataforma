...
public class AcBeanFiltro extends StBean {
    ...
    public AcBeanFiltro(Object nulo) { super(); }
    ...
    public AcBeanFiltro coalesce(AcBeanFiltro pri, AcBeanFiltro sec) {
        AcBeanFiltro r = new AcBeanFiltro(null);
        if ( pri!=null && sec!=null ) {
		r.setAc_sincro( (pri.getAc_sincro()==null)?sec.getAc_sincro():pri.getAc_sincro() );	// sincro
		r.setAc_mark( (pri.getAc_mark()==null)?sec.getAc_mark():pri.getAc_mark() );	// mark
		...
		r.setAc_json( (pri.getAc_json()==null)?sec.getAc_json():pri.getAc_json() );	// json
    ...
    public void copyTo(AcBeanFiltro Destino) {
    ...
    public void copyFrom(AcBeanFiltro Origen) {
