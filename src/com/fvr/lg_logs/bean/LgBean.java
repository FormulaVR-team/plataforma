...
public class LgBean extends StBean {
    ...
    public LgBean(Object nulo) { super(); }
...
*/
    ...
    public String getKey(){
		 return new Long(lg_serial).toString();}

    public void setKey(String key){
            String k="";
	k = key; this.setLg_serial( new Long(k).longValue() );
    }
	////////////////////////////////////////////////////////////
	public String serializar() {
		...
		out.append( _K.sepFld ); out.append( this.getLg_serial() ); // serial
	...
	public void deserializar(String in) {
		...
		if ( in != null && in.length() > 0 ) {
			...
			try { this.setLg_serial( Subrutinas.parse_long( trozos[4] )); } catch (Exception e) {;} // serial
