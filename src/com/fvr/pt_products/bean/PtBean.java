...
public class PtBean extends StBean {
    ...
    public PtBean(Object nulo) { super(); }
	...
	this.setPt_amount( 0.0 ); // amount
	this.setPt_currency( "" ); // currency
	this.setPt_duration_minutes( 0 ); // duration_minutes
...
*/
	...
	public String serializar() {
		...
		out.append( _K.sepFld ); out.append( this.getPt_amount() ); // amount
		out.append( _K.sepFld ); out.append( this.getPt_currency()==null?"":this.getPt_currency() ); // currency
		out.append( _K.sepFld ); out.append( this.getPt_duration_minutes() ); // duration_minutes
	...
	public void deserializar(String in) {
		...
		if ( in != null && in.length() > 0 ) {
			...
			try { this.setPt_amount( Subrutinas.parse_double( trozos[9] )); } catch (Exception e) {;} // amount
			try { this.setPt_currency( trozos[10] ); } catch (Exception e) {;} // currency
			try { this.setPt_duration_minutes( Subrutinas.parse_long( trozos[11] )); } catch (Exception e) {;} // duration_minutes
