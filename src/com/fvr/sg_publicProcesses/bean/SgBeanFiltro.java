...
public class SgBeanFiltro extends StBean {
    ...
    public SgBeanFiltro(Object nulo) { super(); }
    ...
    public SgBeanFiltro coalesce(SgBeanFiltro pri, SgBeanFiltro sec) {
        SgBeanFiltro r = new SgBeanFiltro(null);
        if ( pri!=null && sec!=null ) {
		r.setSg_sincro( (pri.getSg_sincro()==null)?sec.getSg_sincro():pri.getSg_sincro() );	// sincro
		r.setSg_mark( (pri.getSg_mark()==null)?sec.getSg_mark():pri.getSg_mark() );	// mark
		r.setSg_is_deleted( (pri.getSg_is_deleted()==null)?sec.getSg_is_deleted():pri.getSg_is_deleted() );	// is_deleted
		r.setSg_author( (pri.getSg_author()==null)?sec.getSg_author():pri.getSg_author() );	// author
		r.setSg_role_id( (pri.getSg_role_id()==null)?sec.getSg_role_id():pri.getSg_role_id() );	// role_id
		r.setSg_process_id( (pri.getSg_process_id()==null)?sec.getSg_process_id():pri.getSg_process_id() );	// process_id
		r.setSg_json( (pri.getSg_json()==null)?sec.getSg_json():pri.getSg_json() );	// json
        }
        return r;
    }
    
    public void copyTo(SgBeanFiltro Destino) {
    ...
    public void copyFrom(SgBeanFiltro Origen) {
