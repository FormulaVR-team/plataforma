...
public class UsADDRCD_A extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm  form,
        ...
        if ( pantalla.getUs_user_id() != null ) { pantalla.setUs_user_id( pantalla.getUs_user_id().toLowerCase() ); }
...
//            errores.add("error", new ActionMessage( "errors.detail", "'" + usuario + "' no autorizado a '" + proceso + "'." ));
    ...
    private String CamposCalculados(HttpServletRequest request, ActionForm  form) {
        ...
        pantalla.setUs_author( pantalla.getLogon_USR() );
