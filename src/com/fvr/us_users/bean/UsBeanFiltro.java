...
public class UsBeanFiltro extends StBean {
	...
	public String us_country_id; // country_id
	...
	this.setUs_country_id( "" ); // country_id
    ...
    public UsBeanFiltro coalesce(UsBeanFiltro pri, UsBeanFiltro sec) {
		...
		r.setUs_mark( (pri.getUs_mark()==null)?sec.getUs_mark():pri.getUs_mark() );	// mark
		r.setUs_is_deleted( (pri.getUs_is_deleted()==null)?sec.getUs_is_deleted():pri.getUs_is_deleted() );	// is_deleted
		r.setUs_author( (pri.getUs_author()==null)?sec.getUs_author():pri.getUs_author() );	// author
		r.setUs_user_id( (pri.getUs_user_id()==null)?sec.getUs_user_id():pri.getUs_user_id() );	// user_id
		r.setUs_role_id( (pri.getUs_role_id()==null)?sec.getUs_role_id():pri.getUs_role_id() );	// role_id
		r.setUs_hash_code( (pri.getUs_hash_code()==null)?sec.getUs_hash_code():pri.getUs_hash_code() );	// hash_code
		r.setUs_country_id( (pri.getUs_country_id()==null)?sec.getUs_country_id():pri.getUs_country_id() );	// country_id
		r.setUs_PS_name( (pri.getUs_PS_name()==null)?sec.getUs_PS_name():pri.getUs_PS_name() );	// PS_name
		r.setUs_PS_flag_base64( (pri.getUs_PS_flag_base64()==null)?sec.getUs_PS_flag_base64():pri.getUs_PS_flag_base64() );	// PS_flag_base64
		r.setUs_nick( (pri.getUs_nick()==null)?sec.getUs_nick():pri.getUs_nick() );	// nick
		r.setUs_password( (pri.getUs_password()==null)?sec.getUs_password():pri.getUs_password() );	// password
		r.setUs_first_name( (pri.getUs_first_name()==null)?sec.getUs_first_name():pri.getUs_first_name() );	// first_name
		r.setUs_last_name( (pri.getUs_last_name()==null)?sec.getUs_last_name():pri.getUs_last_name() );	// last_name
		r.setUs_phone( (pri.getUs_phone()==null)?sec.getUs_phone():pri.getUs_phone() );	// phone
		r.setUs_gender( (pri.getUs_gender()==null)?sec.getUs_gender():pri.getUs_gender() );	// gender
		r.setUs_birth_day( (pri.getUs_birth_day()==null)?sec.getUs_birth_day():pri.getUs_birth_day() );	// birth_day
		r.setUs_avatar( (pri.getUs_avatar()==null)?sec.getUs_avatar():pri.getUs_avatar() );	// avatar
		r.setUs_location_id( (pri.getUs_location_id()==null)?sec.getUs_location_id():pri.getUs_location_id() );	// location_id
		r.setUs_json( (pri.getUs_json()==null)?sec.getUs_json():pri.getUs_json() );	// json
        }
        return r;
    }
	...
	public String serializar() {
		...
		out.append( _K.sepFld ); out.append( this.getUs_country_id()==null?"":this.getUs_country_id() ); // country_id
	...
	public void deserializar(String in) {
		...
		if ( in != null && in.length() > 0 ) {
			...
			try { this.setUs_country_id( trozos[7] ); } catch (Exception e) {;} // country_id
	...
	/** Get country_id*/
	public String getUs_country_id() {return us_country_id;}
	/** Set country_id*/
	public void setUs_country_id(String us_country_id) {this.us_country_id = us_country_id;}
