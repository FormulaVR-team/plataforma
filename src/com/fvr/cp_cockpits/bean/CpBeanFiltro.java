...
public class CpBeanFiltro extends StBean {
	...
	public String cp_LO_lat; // LO_lat
	public String cp_LO_lon; // LO_lon
    ...
    public CpBeanFiltro(Object nulo) { super(); }
    ...
    public CpBeanFiltro coalesce(CpBeanFiltro pri, CpBeanFiltro sec) {
        CpBeanFiltro r = new CpBeanFiltro(null);
        if ( pri!=null && sec!=null ) {
		r.setCp_sincro( (pri.getCp_sincro()==null)?sec.getCp_sincro():pri.getCp_sincro() );	// sincro
		r.setCp_mark( (pri.getCp_mark()==null)?sec.getCp_mark():pri.getCp_mark() );	// mark
		r.setCp_is_deleted( (pri.getCp_is_deleted()==null)?sec.getCp_is_deleted():pri.getCp_is_deleted() );	// is_deleted
		r.setCp_author( (pri.getCp_author()==null)?sec.getCp_author():pri.getCp_author() );	// author
		r.setCp_location_id( (pri.getCp_location_id()==null)?sec.getCp_location_id():pri.getCp_location_id() );	// location_id
		r.setCp_LO_name( (pri.getCp_LO_name()==null)?sec.getCp_LO_name():pri.getCp_LO_name() );	// LO_name
		r.setCp_LO_address( (pri.getCp_LO_address()==null)?sec.getCp_LO_address():pri.getCp_LO_address() );	// LO_address
		r.setCp_LO_city( (pri.getCp_LO_city()==null)?sec.getCp_LO_city():pri.getCp_LO_city() );	// LO_city
		r.setCp_LO_postal_code( (pri.getCp_LO_postal_code()==null)?sec.getCp_LO_postal_code():pri.getCp_LO_postal_code() );	// LO_postal_code
		r.setCp_LO_lat( (pri.getCp_LO_lat()==null)?sec.getCp_LO_lat():pri.getCp_LO_lat() );	// LO_lat
		r.setCp_LO_lon( (pri.getCp_LO_lon()==null)?sec.getCp_LO_lon():pri.getCp_LO_lon() );	// LO_lon
		r.setCp_cockpit_id( (pri.getCp_cockpit_id()==null)?sec.getCp_cockpit_id():pri.getCp_cockpit_id() );	// cockpit_id
		r.setCp_serial_number( (pri.getCp_serial_number()==null)?sec.getCp_serial_number():pri.getCp_serial_number() );	// serial_number
		r.setCp_name( (pri.getCp_name()==null)?sec.getCp_name():pri.getCp_name() );	// name
		r.setCp_isBlocked( (pri.getCp_isBlocked()==null)?sec.getCp_isBlocked():pri.getCp_isBlocked() );	// isBlocked
		r.setCp_asignation_order( (pri.getCp_asignation_order()==null)?sec.getCp_asignation_order():pri.getCp_asignation_order() );	// asignation_order
		r.setCp_install_date( (pri.getCp_install_date()==null)?sec.getCp_install_date():pri.getCp_install_date() );	// install_date
		r.setCp_reset_date_used( (pri.getCp_reset_date_used()==null)?sec.getCp_reset_date_used():pri.getCp_reset_date_used() );	// reset_date_used
		r.setCp_hours_used( (pri.getCp_hours_used()==null)?sec.getCp_hours_used():pri.getCp_hours_used() );	// hours_used
		r.setCp_note( (pri.getCp_note()==null)?sec.getCp_note():pri.getCp_note() );	// note
		r.setCp_comment( (pri.getCp_comment()==null)?sec.getCp_comment():pri.getCp_comment() );	// comment
    ...
    public void copyTo(CpBeanFiltro Destino) {
	...
	public String serializar() {
		...
		out.append( _K.sepFld ); out.append( this.getCp_LO_lat()==null?"":this.getCp_LO_lat() ); // LO_lat
		out.append( _K.sepFld ); out.append( this.getCp_LO_lon()==null?"":this.getCp_LO_lon() ); // LO_lon
		...
		out.append( _K.sepFld ); out.append( this.getCp_asignation_order()==null?"":this.getCp_asignation_order() ); // asignation_order
		...
		out.append( _K.sepFld ); out.append( this.getCp_hours_used()==null?"":this.getCp_hours_used() ); // hours_used
	...
	public void deserializar(String in) {
		...
		if ( in != null && in.length() > 0 ) {
			...
			try { this.setCp_LO_lat( trozos[9] ); } catch (Exception e) {;} // LO_lat
			try { this.setCp_LO_lon( trozos[10] ); } catch (Exception e) {;} // LO_lon
			...
			try { this.setCp_asignation_order( trozos[15] ); } catch (Exception e) {;} // asignation_order
			...
			try { this.setCp_hours_used( trozos[18] ); } catch (Exception e) {;} // hours_used
	...
	/** Get LO_lat*/
	public String getCp_LO_lat() {return cp_LO_lat;}
	/** Set LO_lat*/
	public void setCp_LO_lat(String cp_LO_lat) {this.cp_LO_lat = cp_LO_lat;}

	/** Get LO_lon*/
	public String getCp_LO_lon() {return cp_LO_lon;}
	/** Set LO_lon*/
	public void setCp_LO_lon(String cp_LO_lon) {this.cp_LO_lon = cp_LO_lon;}
	...
	public String getCp_asignation_order() {return cp_asignation_order;}
	/** Set asignation_order*/
	public void setCp_asignation_order(String cp_asignation_order) {this.cp_asignation_order = cp_asignation_order;}
	...
	/** Get hours_used*/
	public String getCp_hours_used() {return cp_hours_used;}
	/** Set hours_used*/
	public void setCp_hours_used(String cp_hours_used) {this.cp_hours_used = cp_hours_used;}
