...
public class PaBeanFiltro extends StBean {
    ...
    public PaBeanFiltro(Object nulo) { super(); }
    ...
    public PaBeanFiltro coalesce(PaBeanFiltro pri, PaBeanFiltro sec) {
        PaBeanFiltro r = new PaBeanFiltro(null);
        if ( pri!=null && sec!=null ) {
		r.setPa_sincro( (pri.getPa_sincro()==null)?sec.getPa_sincro():pri.getPa_sincro() );	// sincro
		r.setPa_mark( (pri.getPa_mark()==null)?sec.getPa_mark():pri.getPa_mark() );	// mark
		r.setPa_is_deleted( (pri.getPa_is_deleted()==null)?sec.getPa_is_deleted():pri.getPa_is_deleted() );	// is_deleted
		r.setPa_author( (pri.getPa_author()==null)?sec.getPa_author():pri.getPa_author() );	// author
		r.setPa_group_id( (pri.getPa_group_id()==null)?sec.getPa_group_id():pri.getPa_group_id() );	// group_id
		r.setPa_key( (pri.getPa_key()==null)?sec.getPa_key():pri.getPa_key() );	// key
		r.setPa_value( (pri.getPa_value()==null)?sec.getPa_value():pri.getPa_value() );	// value
        }
        return r;
    }
    
    public void copyTo(PaBeanFiltro Destino) {
    ...
    public void copyFrom(PaBeanFiltro Origen) {
