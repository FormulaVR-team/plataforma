...
class ApacheHttpMethods implements IHttpMethods {
	 ...
	 * {@inheritDoc}
	 */
	public String doPost(String url, List<NameValuePair> params, Map<String, String> headers, String payload)
			throws StExcepcion {
	 ...
	 * {@inheritDoc}
	 */
	public String doPost(IHttpClient httpClientBuilder, String url, List<NameValuePair> params, Map<String, String> headers, String payload)
			throws StExcepcion {
		String result = null;
