...
public class EsBean extends StBean {
    ...
    public EsBean(Object nulo) { super(); }
...
*/
    ...
    public String getKey(){
		 return es_event_id + "^" + 
		es_inscription_user_id;}

    public void setKey(String key){
            String k="";
	k = key.trim().substring( 0, key.indexOf("^") ); this.setEs_event_id( k ); key = key.trim().substring( key.indexOf("^")+1 );
	k = key; this.setEs_inscription_user_id( k );
    }
	////////////////////////////////////////////////////////////
	...
	public void deserializar(String in) {
		...
		if ( in != null && in.length() > 0 ) {
			...
			try { this.setEs_amount( Subrutinas.parse_double( trozos[12] )); } catch (Exception e) {;} // amount
