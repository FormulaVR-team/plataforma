...
public class RsBean extends StBean {
    ...
    public RsBean(Object nulo) { super(); }
	...
	this.setRs_US_country_id( 0 ); // US_country_id
	...
	this.setRs_PT_amount( 0.0 ); // PT_amount
	this.setRs_PT_duration_minutes( 0 ); // PT_duration_minutes
	this.setRs_quantity( 0 ); // quantity
	...
	this.setRs_PT_amount2( 0.0 ); // PT_amount2
	...
	this.setRs_PT_amount3( 0.0 ); // PT_amount3
	this.setRs_amount( 0.0 ); // amount
	...
	this.setRs_duration_minutes( 0 ); // duration_minutes
	this.setRs_places( 0 ); // places
...
*/
    ...
    public String getKey(){
		 return rs_reservation_id;}

    public void setKey(String key){
            String k="";
	k = key; this.setRs_reservation_id( k );
    }
	////////////////////////////////////////////////////////////
	public String serializar() {
		...
		out.append( _K.sepFld ); out.append( this.getRs_US_country_id() ); // US_country_id
		...
		out.append( _K.sepFld ); out.append( this.getRs_PT_amount() ); // PT_amount
		out.append( _K.sepFld ); out.append( this.getRs_PT_duration_minutes() ); // PT_duration_minutes
		out.append( _K.sepFld ); out.append( this.getRs_quantity() ); // quantity
		...
		out.append( _K.sepFld ); out.append( this.getRs_PT_amount2() ); // PT_amount2
		...
		out.append( _K.sepFld ); out.append( this.getRs_PT_amount3() ); // PT_amount3
		out.append( _K.sepFld ); out.append( this.getRs_amount() ); // amount
		...
		out.append( _K.sepFld ); out.append( this.getRs_duration_minutes() ); // duration_minutes
		out.append( _K.sepFld ); out.append( this.getRs_places() ); // places
	...
	public void deserializar(String in) {
		...
		if ( in != null && in.length() > 0 ) {
			...
			try { this.setRs_US_country_id( Subrutinas.parse_long( trozos[8] )); } catch (Exception e) {;} // US_country_id
			...
			try { this.setRs_PT_amount( Subrutinas.parse_double( trozos[18] )); } catch (Exception e) {;} // PT_amount
			try { this.setRs_PT_duration_minutes( Subrutinas.parse_long( trozos[19] )); } catch (Exception e) {;} // PT_duration_minutes
			try { this.setRs_quantity( Subrutinas.parse_long( trozos[20] )); } catch (Exception e) {;} // quantity
			...
			try { this.setRs_PT_amount2( Subrutinas.parse_double( trozos[25] )); } catch (Exception e) {;} // PT_amount2
			...
			try { this.setRs_PT_amount3( Subrutinas.parse_double( trozos[30] )); } catch (Exception e) {;} // PT_amount3
			try { this.setRs_amount( Subrutinas.parse_double( trozos[31] )); } catch (Exception e) {;} // amount
			...
			try { this.setRs_duration_minutes( Subrutinas.parse_long( trozos[37] )); } catch (Exception e) {;} // duration_minutes
			try { this.setRs_places( Subrutinas.parse_long( trozos[38] )); } catch (Exception e) {;} // places
