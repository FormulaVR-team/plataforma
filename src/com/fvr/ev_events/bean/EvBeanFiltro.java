...
public class EvBeanFiltro extends StBean {
	...
	public String ev_max_inscriptions; // max_inscriptions
	public String ev_amount; // amount
    ...
    public EvBeanFiltro(Object nulo) { super(); }
	...
	this.setEv_max_inscriptions( "" ); // max_inscriptions
	this.setEv_amount( "" ); // amount
    ...
    public EvBeanFiltro coalesce(EvBeanFiltro pri, EvBeanFiltro sec) {
        EvBeanFiltro r = new EvBeanFiltro(null);
        if ( pri!=null && sec!=null ) {
		r.setEv_sincro( (pri.getEv_sincro()==null)?sec.getEv_sincro():pri.getEv_sincro() );	// sincro
		r.setEv_mark( (pri.getEv_mark()==null)?sec.getEv_mark():pri.getEv_mark() );	// mark
		r.setEv_is_deleted( (pri.getEv_is_deleted()==null)?sec.getEv_is_deleted():pri.getEv_is_deleted() );	// is_deleted
		r.setEv_author( (pri.getEv_author()==null)?sec.getEv_author():pri.getEv_author() );	// author
		r.setEv_event_id( (pri.getEv_event_id()==null)?sec.getEv_event_id():pri.getEv_event_id() );	// event_id
		r.setEv_location_id( (pri.getEv_location_id()==null)?sec.getEv_location_id():pri.getEv_location_id() );	// location_id
		r.setEv_LO_name( (pri.getEv_LO_name()==null)?sec.getEv_LO_name():pri.getEv_LO_name() );	// LO_name
		r.setEv_name( (pri.getEv_name()==null)?sec.getEv_name():pri.getEv_name() );	// name
		r.setEv_max_inscriptions( (pri.getEv_max_inscriptions()==null)?sec.getEv_max_inscriptions():pri.getEv_max_inscriptions() );	// max_inscriptions
		r.setEv_amount( (pri.getEv_amount()==null)?sec.getEv_amount():pri.getEv_amount() );	// amount
		r.setEv_currency( (pri.getEv_currency()==null)?sec.getEv_currency():pri.getEv_currency() );	// currency
		r.setEv_deadline( (pri.getEv_deadline()==null)?sec.getEv_deadline():pri.getEv_deadline() );	// deadline
		r.setEv_comment( (pri.getEv_comment()==null)?sec.getEv_comment():pri.getEv_comment() );	// comment
		r.setEv_date1( (pri.getEv_date1()==null)?sec.getEv_date1():pri.getEv_date1() );	// date1
		r.setEv_date2( (pri.getEv_date2()==null)?sec.getEv_date2():pri.getEv_date2() );	// date2
		r.setEv_date3( (pri.getEv_date3()==null)?sec.getEv_date3():pri.getEv_date3() );	// date3
		r.setEv_date4( (pri.getEv_date4()==null)?sec.getEv_date4():pri.getEv_date4() );	// date4
		r.setEv_json( (pri.getEv_json()==null)?sec.getEv_json():pri.getEv_json() );	// json
        }
        return r;
    }
    
    public void copyTo(EvBeanFiltro Destino) {
    ...
    public void copyFrom(EvBeanFiltro Origen) {
	...
	public String serializar() {
		...
		out.append( _K.sepFld ); out.append( this.getEv_max_inscriptions()==null?"":this.getEv_max_inscriptions() ); // max_inscriptions
		out.append( _K.sepFld ); out.append( this.getEv_amount()==null?"":this.getEv_amount() ); // amount
	...
	public void deserializar(String in) {
		...
		if ( in != null && in.length() > 0 ) {
			...
			try { this.setEv_max_inscriptions( trozos[8] ); } catch (Exception e) {;} // max_inscriptions
			try { this.setEv_amount( trozos[9] ); } catch (Exception e) {;} // amount
	...
	public String getEv_max_inscriptions() {return ev_max_inscriptions;}
	/** Set max_inscriptions*/
	public void setEv_max_inscriptions(String ev_max_inscriptions) {this.ev_max_inscriptions = ev_max_inscriptions;}

	/** Get amount*/
	public String getEv_amount() {return ev_amount;}
	/** Set amount*/
	public void setEv_amount(String ev_amount) {this.ev_amount = ev_amount;}
