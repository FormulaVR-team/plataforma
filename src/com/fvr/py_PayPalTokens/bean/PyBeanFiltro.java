...
public class PyBeanFiltro extends StBean {
    ...
    public PyBeanFiltro(Object nulo) { super(); }
    ...
    public PyBeanFiltro coalesce(PyBeanFiltro pri, PyBeanFiltro sec) {
        PyBeanFiltro r = new PyBeanFiltro(null);
        if ( pri!=null && sec!=null ) {
		r.setPy_sincro( (pri.getPy_sincro()==null)?sec.getPy_sincro():pri.getPy_sincro() );	// sincro
		r.setPy_mark( (pri.getPy_mark()==null)?sec.getPy_mark():pri.getPy_mark() );	// mark
		r.setPy_is_deleted( (pri.getPy_is_deleted()==null)?sec.getPy_is_deleted():pri.getPy_is_deleted() );	// is_deleted
		r.setPy_author( (pri.getPy_author()==null)?sec.getPy_author():pri.getPy_author() );	// author
		r.setPy_user_id( (pri.getPy_user_id()==null)?sec.getPy_user_id():pri.getPy_user_id() );	// user_id
		r.setPy_US_first_name( (pri.getPy_US_first_name()==null)?sec.getPy_US_first_name():pri.getPy_US_first_name() );	// US_first_name
		r.setPy_US_last_name( (pri.getPy_US_last_name()==null)?sec.getPy_US_last_name():pri.getPy_US_last_name() );	// US_last_name
		r.setPy_reservation_id( (pri.getPy_reservation_id()==null)?sec.getPy_reservation_id():pri.getPy_reservation_id() );	// reservation_id
		r.setPy_paypal_token_id( (pri.getPy_paypal_token_id()==null)?sec.getPy_paypal_token_id():pri.getPy_paypal_token_id() );	// paypal_token_id
		r.setPy_paypal_usr( (pri.getPy_paypal_usr()==null)?sec.getPy_paypal_usr():pri.getPy_paypal_usr() );	// paypal_usr
		r.setPy_paypal_pwd( (pri.getPy_paypal_pwd()==null)?sec.getPy_paypal_pwd():pri.getPy_paypal_pwd() );	// paypal_pwd
		r.setPy_paypal_signature( (pri.getPy_paypal_signature()==null)?sec.getPy_paypal_signature():pri.getPy_paypal_signature() );	// paypal_signature
		r.setPy_stsProceso( (pri.getPy_stsProceso()==null)?sec.getPy_stsProceso():pri.getPy_stsProceso() );	// stsProceso
		r.setPy_json( (pri.getPy_json()==null)?sec.getPy_json():pri.getPy_json() );	// json
        }
        return r;
    }
    
    public void copyTo(PyBeanFiltro Destino) {
    ...
    public void copyFrom(PyBeanFiltro Origen) {
